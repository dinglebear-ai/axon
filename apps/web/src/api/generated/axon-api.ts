...
export type paths = {
    ...
    "/v1/agent/turns/{id}/resume": { post: operations["v1_agent_resume"] };
    ...
    "/v1/code-search": { post: operations["codeSearch"] };
    "/v1/codex": { get: operations["snapshot_openapi_marker"] };
    "/v1/codex/events": { get: operations["events_openapi_marker"] };
    "/v1/codex/operations": { get: operations["list_operations_openapi_marker"]; post: operations["create_operation_openapi_marker"] };
    "/v1/codex/operations/{id}/approve": { post: operations["approve_operation_openapi_marker"] };
    "/v1/codex/operations/{id}/cancel": { post: operations["cancel_operation_openapi_marker"] };
    "/v1/codex/operations/{id}/execute": { post: operations["execute_operation_openapi_marker"] };
    "/v1/codex/operations/{id}/reconcile": { post: operations["reconcile_operation_openapi_marker"] };
    "/v1/codex/read": { post: operations["read_action_openapi_marker"] };
    "/v1/codex/server-requests/{id}/respond": { post: operations["respond_to_server_request_openapi_marker"] };
    "/v1/codex/{resource}": { get: operations["resource_openapi_marker"] };
    "/v1/collections": { get: operations["collections_openapi_marker"] };
    "/v1/crawl": { post: operations["crawlSources"] };
    "/v1/diff": { post: operations["diff"] };
    "/v1/doctor": { get: operations["doctor"] };
    "/v1/domains": { get: operations["domains"] };
    "/v1/embed": { post: operations["embedSources"] };
    "/v1/endpoints": { post: operations["endpoints"] };
    "/v1/evaluate": { post: operations["evaluate"] };
    "/v1/extract": { post: operations["start_extract"] };
    ...
    "/v1/ingest": { post: operations["ingestSources"] };
    ...
    "/v1/memories": { get: operations["list_memories"]; post: operations["remember_memory"] };
    ...
    "/v1/uploads": { get: operations["list_uploads"]; post: operations["create_upload"] };
    "/v1/uploads/{upload_id}": { get: operations["get_upload"]; delete: operations["abort_upload"] };
    "/v1/uploads/{upload_id}/complete": { post: operations["complete_upload"] };
    "/v1/uploads/{upload_id}/content": { put: operations["put_upload_content"] };
    ...
    "/v1/watches/{watch_id}/history": { get: operations["watches_history"] };
    "/v1/watches/{watch_id}/pause": { post: operations["watches_pause"] };
    "/v1/watches/{watch_id}/resume": { post: operations["watches_resume"] };
    "/v1/watches/{watch_id}/status": { get: operations["watches_status"] };
};
...
export type operations = {
    ...
    "v1_agent_status": { method: "get"; path: "/v1/agent/turns/{id}"; operationId: "v1_agent_status"; parameters: { query: Record<string, never>; path: { "id": string } }; requestBody: never; responses: { "200": components['schemas']['AgentTurnResult']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody']; "404": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    "v1_agent_cancel": { method: "post"; path: "/v1/agent/turns/{id}/cancel"; operationId: "v1_agent_cancel"; parameters: { query: Record<string, never>; path: { "id": string } }; requestBody: never; responses: { "200": components['schemas']['AgentTurnResult']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody']; "502": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    "v1_agent_events": { method: "get"; path: "/v1/agent/turns/{id}/events"; operationId: "v1_agent_events"; parameters: { query: { "after"?: number }; path: { "id": string } }; requestBody: never; responses: { "200": unknown; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody']; "404": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    "v1_agent_resume": { method: "post"; path: "/v1/agent/turns/{id}/resume"; operationId: "v1_agent_resume"; parameters: { query: Record<string, never>; path: { "id": string } }; requestBody: components['schemas']['AgentResumeRequest']; responses: { "200": components['schemas']['AgentTurnResult']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    ...
    "snapshot_openapi_marker": { method: "get"; path: "/v1/codex"; operationId: "snapshot_openapi_marker"; parameters: { query: Record<string, never>; path: Record<string, never> }; requestBody: never; responses: { "200": components['schemas']['CodexControlSnapshot']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody']; "404": components['schemas']['ErrorBody']; "503": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    "events_openapi_marker": { method: "get"; path: "/v1/codex/events"; operationId: "events_openapi_marker"; parameters: { query: { "boot_id"?: number; "after"?: number; "limit"?: number }; path: Record<string, never> }; requestBody: never; responses: { "200": components['schemas']['RecordedEvent'][]; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody']; "502": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    "list_operations_openapi_marker": { method: "get"; path: "/v1/codex/operations"; operationId: "list_operations_openapi_marker"; parameters: { query: Record<string, never>; path: Record<string, never> }; requestBody: never; responses: { "200": components['schemas']['ControlOperation'][]; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody']; "502": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    "create_operation_openapi_marker": { method: "post"; path: "/v1/codex/operations"; operationId: "create_operation_openapi_marker"; parameters: { query: Record<string, never>; path: Record<string, never> }; requestBody: components['schemas']['CreateOperationBody']; responses: { "200": components['schemas']['ControlOperation']; "400": components['schemas']['ErrorBody']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    "approve_operation_openapi_marker": { method: "post"; path: "/v1/codex/operations/{id}/approve"; operationId: "approve_operation_openapi_marker"; parameters: { query: Record<string, never>; path: { "id": number } }; requestBody: never; responses: { "200": components['schemas']['ApproveOperationResponse']; "400": components['schemas']['ErrorBody']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    "cancel_operation_openapi_marker": { method: "post"; path: "/v1/codex/operations/{id}/cancel"; operationId: "cancel_operation_openapi_marker"; parameters: { query: Record<string, never>; path: { "id": number } }; requestBody: never; responses: { "200": components['schemas']['ReconcileOperationResponse']; "400": components['schemas']['ErrorBody']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    "execute_operation_openapi_marker": { method: "post"; path: "/v1/codex/operations/{id}/execute"; operationId: "execute_operation_openapi_marker"; parameters: { query: Record<string, never>; path: { "id": number } }; requestBody: components['schemas']['ExecuteBody']; responses: { "200": components['schemas']['ExecuteOperationResponse']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody']; "502": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    "reconcile_operation_openapi_marker": { method: "post"; path: "/v1/codex/operations/{id}/reconcile"; operationId: "reconcile_operation_openapi_marker"; parameters: { query: Record<string, never>; path: { "id": number } }; requestBody: components['schemas']['ReconcileOperationBody']; responses: { "200": components['schemas']['ReconcileOperationResponse']; "400": components['schemas']['ErrorBody']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    "read_action_openapi_marker": { method: "post"; path: "/v1/codex/read"; operationId: "read_action_openapi_marker"; parameters: { query: Record<string, never>; path: Record<string, never> }; requestBody: components['schemas']['CodexReadBody']; responses: { "200": components['schemas']['CodexResourceResponse']; "400": components['schemas']['ErrorBody']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    "respond_to_server_request_openapi_marker": { method: "post"; path: "/v1/codex/server-requests/{id}/respond"; operationId: "respond_to_server_request_openapi_marker"; parameters: { query: Record<string, never>; path: { "id": number } }; requestBody: components['schemas']['ServerRequestResponseBody']; responses: { "200": components['schemas']['ServerRequestRespondedResponse']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody']; "502": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    "resource_openapi_marker": { method: "get"; path: "/v1/codex/{resource}"; operationId: "resource_openapi_marker"; parameters: { query: Record<string, never>; path: { "resource": string } }; requestBody: never; responses: { "200": components['schemas']['CodexResourceResponse']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody']; "404": components['schemas']['ErrorBody']; "502": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    ...
    "embedSources": { method: "post"; path: "/v1/embed"; operationId: "embedSources"; parameters: { query: Record<string, never>; path: Record<string, never> }; requestBody: components['schemas']['EmbedRequest']; responses: { "200": components['schemas']['BatchResult_SourceResult']; "202": components['schemas']['BatchResult_SourceResult']; "400": components['schemas']['ErrorBody']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody']; "409": components['schemas']['ErrorBody']; "413": components['schemas']['ErrorBody']; "429": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    ...
    "ingestSources": { method: "post"; path: "/v1/ingest"; operationId: "ingestSources"; parameters: { query: Record<string, never>; path: Record<string, never> }; requestBody: components['schemas']['IngestRequest']; responses: { "200": components['schemas']['BatchResult_SourceResult']; "202": components['schemas']['BatchResult_SourceResult']; "400": components['schemas']['ErrorBody']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody']; "409": components['schemas']['ErrorBody']; "413": components['schemas']['ErrorBody']; "429": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    "list_unified_jobs": { method: "get"; path: "/v1/jobs"; operationId: "list_unified_jobs"; parameters: { query: { "status"?: components['schemas']['LifecycleStatus']; "kind"?: components['schemas']['JobKind']; "limit"?: number; "cursor"?: string }; path: Record<string, never> }; requestBody: never; responses: { "200": components['schemas']['Page_JobSummary']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    ...
    "prune_get_plan": { method: "get"; path: "/v1/prune/plans/{plan_id}"; operationId: "prune_get_plan"; parameters: { query: Record<string, never>; path: { "plan_id": string } }; requestBody: never; responses: { "200": components['schemas']['StoredPrunePlan']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody']; "404": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    ...
    "reset_get_plan": { method: "get"; path: "/v1/reset/plans/{plan_id}"; operationId: "reset_get_plan"; parameters: { query: Record<string, never>; path: { "plan_id": string } }; requestBody: never; responses: { "200": components['schemas']['ResetResult']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody']; "404": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    ...
    "list_uploads": { method: "get"; path: "/v1/uploads"; operationId: "list_uploads"; parameters: { query: { "status"?: components['schemas']['UploadStatusKind']; "limit"?: number; "cursor"?: string }; path: Record<string, never> }; requestBody: never; responses: { "200": components['schemas']['Page_UploadStatus']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    "create_upload": { method: "post"; path: "/v1/uploads"; operationId: "create_upload"; parameters: { query: Record<string, never>; path: Record<string, never> }; requestBody: components['schemas']['UploadCreateRequest']; responses: { "200": components['schemas']['UploadCreateResult']; "400": components['schemas']['ErrorBody']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    "get_upload": { method: "get"; path: "/v1/uploads/{upload_id}"; operationId: "get_upload"; parameters: { query: Record<string, never>; path: { "upload_id": string } }; requestBody: never; responses: { "200": components['schemas']['UploadStatus']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody']; "404": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
    ...
    "watches_list": { method: "get"; path: "/v1/watches"; operationId: "watches_list"; parameters: { query: { "enabled"?: boolean | null; "source_id"?: string | null; "adapter"?: string | null; "limit"?: number | null; "cursor"?: string | null }; path: Record<string, never> }; requestBody: never; responses: { "200": components['schemas']['Page_WatchSummary']; "401": components['schemas']['ErrorBody']; "403": components['schemas']['ErrorBody']; "502": components['schemas']['ErrorBody'] }; security: "bearerAuth" | "oauth2" };
