...
pub fn canonicalize_url_for_dedupe(url: &str) -> Option<String> {
...
pub fn is_excluded_url_path(url: &str, excludes: &[String]) -> bool {
...
pub fn is_junk_discovered_url(url: &str) -> bool {
    if url.len() > 2048 {
        return true;
    }
