...
#[utoipa::path(
    ...
    responses(
        ...
        (status = 502, description = "Upstream crawl, render, or LLM service unavailable", body = crate::server::error::ErrorBody)
    ),
    tag = "exploration"
)]
...
#[utoipa::path(
    ...
    responses(
        ...
        (status = 400, description = "Invalid endpoint discovery request", body = crate::server::error::ErrorBody),
        (status = 502, description = "Upstream fetch or verification service unavailable", body = crate::server::error::ErrorBody)
    ),
    tag = "exploration"
)]
...
#[utoipa::path(
    ...
    responses(
        ...
        (status = 400, description = "Invalid brand request", body = crate::server::error::ErrorBody),
        (status = 502, description = "Upstream page fetch unavailable", body = crate::server::error::ErrorBody)
    ),
    tag = "exploration"
)]
...
#[utoipa::path(
    ...
    responses(
        ...
        (status = 400, description = "Invalid diff request", body = crate::server::error::ErrorBody),
        (status = 502, description = "Upstream scrape unavailable", body = crate::server::error::ErrorBody)
    ),
    tag = "exploration"
)]
...
#[utoipa::path(
    ...
    responses(
        ...
        (status = 400, description = "Invalid screenshot request", body = crate::server::error::ErrorBody),
        (status = 502, description = "Chrome screenshot service unavailable", body = crate::server::error::ErrorBody)
    ),
    tag = "exploration"
)]
...
#[utoipa::path(
    ...
    responses(
        ...
        (status = 504, description = "Research request timed out", body = crate::server::error::ErrorBody)
    ),
    tag = "exploration"
)]
