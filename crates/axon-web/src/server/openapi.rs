...
#[openapi(
    ...
    paths(
        ...
        handlers::agent::v1_agent_status,
        handlers::agent::v1_agent_events,
        handlers::agent::v1_agent_cancel,
        handlers::agent::v1_agent_resume,
        handlers::rag::query,
        handlers::rag::retrieve,
        handlers::rag::evaluate,
        handlers::rag::suggest,
        handlers::sources::index_source,
        handlers::projections::scrape,
        handlers::projections::crawl,
        handlers::projections::embed,
        handlers::projections::ingest,
        handlers::projections::code_search,
        handlers::sources_resource::get_source,
        handlers::sources_resource::resolve_source,
        ...
        handlers::admin::prune_get_plan,
        handlers::admin::prune_exec,
        handlers::admin::reset_plan,
        handlers::admin::reset_get_plan,
        handlers::admin::reset_exec,
        handlers::source_watch::create_watch,
        handlers::source_watch::list_watches,
        handlers::source_watch::get_watch,
        handlers::source_watch::status_watch,
        handlers::source_watch::history_watch,
        handlers::source_watch::update_watch,
        handlers::source_watch::exec_watch,
    ...
    components(schemas(
        ...
        axon_api::agent::AgentTurnOptions,
        axon_api::agent::AgentResumeRequest,
        axon_api::agent::AgentApprovalToken,
        axon_api::agent::AgentToolProposal,
        axon_api::agent::AgentTurnStatus,
        axon_api::agent::AgentTurnResult,
        axon_api::agent::AgentCorrelation,
        axon_api::agent::AgentEvent,
        ...
        axon_api::source::TraceContext,
        axon_api::source::MetadataMap,
        axon_api::source::PageInfo,
        axon_api::source::ArtifactRef,
        axon_api::source::ArtifactListRequest,
        axon_api::source::UploadId,
        axon_api::source::UploadPurpose,
        axon_api::source::UploadStatusKind,
        axon_api::source::UploadCreateRequest,
        axon_api::source::UploadCreateResult,
        axon_api::source::UploadStatus,
        axon_api::source::UploadCompleteRequest,
        axon_api::source::UploadCompleteResult,
        axon_api::source::UploadAbortRequest,
        axon_api::source::UploadAbortResult,
        axon_api::source::UploadListRequest,
        axon_services::artifacts::ArtifactSummary,
        axon_services::artifacts::ArtifactDetail,
        axon_services::artifacts::ArtifactContentDescriptor,
        axon_api::source::SuccessEnvelope<axon_services::types::QueryResult>,
        axon_api::source::SuccessEnvelope<axon_services::types::RetrieveResult>,
        axon_api::ApiError,
        ...
        axon_api::source::MemoryItem,
        axon_api::source::MemoryEdgeItem,
        axon_api::source::MemoryContext,
        axon_api::source::MemoryItemsResponse,
        axon_api::source::MemoryItemResponse,
        axon_api::source::MemoryContextResponse,
        axon_api::source::MemoryEdgeResponse,
        ...
        handlers::admin::ResetPlanRequest,
        handlers::admin::ResetExecRequest,
        axon_api::reset::ResetPlan,
        axon_api::reset::ResetResult,
        axon_api::reset::ResetEstimate,
        axon_api::reset::ResetExecutionState,
        axon_api::reset::ResetStorePlan,
        axon_api::reset::ResetDeleted,
        axon_api::reset::ResetCreated,
        axon_api::reset::ResetChunkReceipt,
