...
async fn stats_payload(cfg: &Config) -> Result<serde_json::Value, Box<dyn Error>> {
    ...
    Ok(serde_json::json!({
        ...
        "avg_overall_crawl_duration_seconds": job_metrics.average_overall_source_duration_seconds,
        "longest_crawl": job_metrics.longest_source,
        ...
        "freshness": {
            ...
            "crawls_last_24h": job_metrics.sources_last_24h,
            "crawls_last_7d": job_metrics.sources_last_7d,
        },
        "growth_7d": job_metrics.chunks_per_day_7d,
        "counts": {
            "crawls": job_metrics.source_count,
