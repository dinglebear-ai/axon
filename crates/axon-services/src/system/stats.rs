...
async fn stats_payload(cfg: &Config) -> Result<serde_json::Value, Box<dyn Error>> {
    ...
    Ok(serde_json::json!({
        ...
        "avg_items_per_second": job_metrics.average_items_per_second,
        "avg_source_duration_seconds": job_metrics.average_source_duration_seconds,
        "avg_embedding_duration_seconds": job_metrics.average_embedding_duration_seconds,
        "avg_overall_source_duration_seconds": job_metrics.average_overall_source_duration_seconds,
        "longest_source": job_metrics.longest_source,
        ...
        "freshness": {
            ...
            "sources_last_24h": job_metrics.sources_last_24h,
            "sources_last_7d": job_metrics.sources_last_7d,
        },
        "growth_7d": job_metrics.chunks_per_day_7d,
        "counts": {
            "sources": job_metrics.source_count,
