...
use super::{NonWebPipelineInput, SourceEventEmitter, TargetLocalSourceRuntime};
...
impl ProgressCoordinator {
    pub(super) fn new(runtime: &TargetLocalSourceRuntime, input: &NonWebPipelineInput<'_>) -> Self {
        Self {
