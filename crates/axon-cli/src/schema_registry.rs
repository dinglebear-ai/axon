...
const COMMAND_REGISTRY: &[CliCommandSpec] = &[
    CliCommandSpec {
        name: "ask",
    ...
    CliCommandSpec {
        name: "scrape",
        maps_to_dto: Some("ScrapeRequest"),
        mutates: true,
        async_job: true,
    ...
    CliCommandSpec {
        name: "ingest",
        maps_to_dto: Some("IngestRequest"),
        mutates: true,
        async_job: true,
        required_scope: "write",
    },
    CliCommandSpec {
        name: "code-search",
        maps_to_dto: Some("CodeSearchRequest"),
        mutates: false,
        async_job: false,
        required_scope: "read",
    },
