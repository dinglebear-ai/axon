...
impl Default for Config {
    fn default() -> Self {
        Self {
            ...
            codex_control_plugin_writes: false,
            codex_control_skill_writes: false,
            ...
            openai_embed_model: "axon-qwen3-embedding".to_string(),
            openai_embed_max_client_batch_size: 32,
            openai_embed_max_concurrent: 32,
            openai_embed_max_in_flight_inputs: 512,
            openai_embed_pool_max_inputs: 1024,
            unified_worker_concurrency: 8,
            source_job_concurrency_limit: 4,
            embed_doc_timeout_secs: 300,
            queue_summary_secs: 30,
            qdrant_point_buffer: 1024,
            hnsw_ef_search: 128,
            hnsw_ef_search_legacy: 128,
            ...
            max_job_attempts: 5,
            jobs_retention_terminal_days: 30,
            jobs_retention_event_days: 14,
            jobs_retention_failed_event_days: 60,
            jobs_retention_provider_health_days: 7,
            jobs_retention_artifact_days: 30,
