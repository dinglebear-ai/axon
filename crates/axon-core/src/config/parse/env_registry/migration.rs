...
pub(crate) const MIGRATION_ENV_KEY_SPECS: &[EnvKeySpec] = &[
    ...
    spec(
        ...
        MoveToml,
        NotRuntime,
        Some("embed.tei-retry-backoff-ms"),
        WarnEnvOverride,
        false,
    ),
    spec(
        ...
        MoveToml,
        NotRuntime,
        Some("embed.tei-cooldown-after-failures"),
        WarnEnvOverride,
        false,
    ),
    spec(
    ...
    spec(
        ...
        MoveToml,
        NotRuntime,
        Some("embed.tei-interactive-reserved-requests"),
        WarnEnvOverride,
        false,
    ),
    spec(
        ...
        MoveToml,
        NotRuntime,
        Some("embed.tei-background-max-concurrent-requests"),
        WarnEnvOverride,
        false,
    ),
    spec(
        ...
        MoveToml,
        NotRuntime,
        Some("embed.tei-maintenance-max-concurrent-requests"),
        WarnEnvOverride,
        false,
    ),
    spec(
        ...
        MoveToml,
        NotRuntime,
        Some("embed.tei-query-instruction-enabled"),
        WarnEnvOverride,
        false,
    ),
    spec(
    ...
    spec(
        ...
        MoveToml,
        NotRuntime,
        Some("embed.openai-max-client-batch-size"),
        WarnEnvOverride,
        false,
    ),
    spec(
        ...
        MoveToml,
        NotRuntime,
        Some("embed.openai-max-concurrent"),
        WarnEnvOverride,
        false,
    ),
    spec(
        ...
        MoveToml,
        NotRuntime,
        Some("embed.openai-max-in-flight-inputs"),
        WarnEnvOverride,
        false,
    ),
    spec(
        ...
        MoveToml,
        NotRuntime,
        Some("embed.openai-pool-max-inputs"),
        WarnEnvOverride,
        false,
    ),
    spec(
