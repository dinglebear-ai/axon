...
- `skills.sh`, `skills.sh:leaderboard`, and `skills.sh:search` canonicalize deterministically to `catalog://skills.sh/...` as `registry + api`; route-time code declares bearer auth but never reads or logs the credential.
