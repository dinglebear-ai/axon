...
See [Source Pipeline](docs/architecture/source-pipeline.md) for the current
stage order, ownership boundaries, transport projections, and execution modes.
...
- MCP schema/documentation sync (`cargo xtask schemas mcp --check`).
...
- `docs/` — living guides, generated references, architecture,
  operations, development documentation, and dated history records.
