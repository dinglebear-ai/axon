...
- Run Axon's long fail-fast contract compilation directly through rustc after the Kache self-test, avoiding ephemeral wrapper loss while preserving the cache setup and degradation gate.
