...
fn commands_search_brand_debug_doctor() -> Vec<CliRegistryCommand> {
    vec![
        ...
        c(
            &["scrape"],
            "Fetch, normalize, and index exactly one web page through the scrape projection",
            Some("ScrapeRequest"),
            true,
            true,
            "write",
        ...
        c(
            &["crawl"],
            "Crawl source roots through the canonical source projection",
            Some("CrawlRequest"),
            true,
            true,
            "write",
        ...
        c(
            &["embed"],
            "Embed sources through the canonical source projection",
            Some("EmbedRequest"),
            true,
            true,
            "write",
        ...
        c(
            &["ingest"],
            "Ingest sources through the canonical source projection",
            Some("IngestRequest"),
            true,
            true,
            "write",
