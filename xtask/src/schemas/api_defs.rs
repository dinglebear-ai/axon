...
fn source_document_defs() -> Vec<(&'static str, Value)> {
    vec![
        ...
        schema_def::<axon_api::source::ArtifactCandidate>("ArtifactCandidate"),
        schema_def::<axon_api::source::ArtifactCandidateBatch>("ArtifactCandidateBatch"),
        schema_def::<axon_api::source::ArtifactCandidateSinkResult>("ArtifactCandidateSinkResult"),
        schema_def::<axon_api::source::ArtifactCandidateSinkCapability>(
            "ArtifactCandidateSinkCapability",
        ),
...
fn source_operation_defs() -> Vec<(&'static str, Value)> {
    vec![
        ...
        schema_def::<axon_api::source::UploadCreateResult>("UploadCreateResult"),
        schema_def::<axon_api::source::UploadStatus>("UploadStatus"),
        schema_def::<axon_api::source::UploadContentRequest>("UploadContentRequest"),
        schema_def::<axon_api::source::UploadCompleteRequest>("UploadCompleteRequest"),
        schema_def::<axon_api::source::UploadCompleteResult>("UploadCompleteResult"),
        schema_def::<axon_api::source::UploadAbortRequest>("UploadAbortRequest"),
        schema_def::<axon_api::source::UploadAbortResult>("UploadAbortResult"),
        schema_def::<axon_api::source::UploadListRequest>("UploadListRequest"),
