...
VALID_TOML_DESTINATIONS = {
    ...
    "tei.retry-backoff-ms",
    "tei.cooldown-after-failures",
    "tei.cooldown-secs",
    "tei.interactive-reserved-requests",
    "tei.background-max-concurrent-requests",
    "tei.maintenance-max-concurrent-requests",
    "tei.query-instruction-enabled",
