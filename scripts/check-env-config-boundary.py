...
IGNORED_TOKENS = {
    ...
    "AXON_E2E_GATEWAY_PEER",
    "AXON_E2E_GATEWAY_SERVICE",
    "AXON_E2E_GATEWAY_STATE",
    "AXON_E2E_GATEWAY_TAG",
    "AXON_E2E_GATEWAY_TOKEN",
    "AXON_E2E_GATEWAY_UPSTREAM",
    "AXON_E2E_GATEWAY_UPSTREAM_TOKEN",
    "AXON_E2E_HERMETIC",
    "AXON_E2E_LIVE",
