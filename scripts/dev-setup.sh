...
echo "       AXON_HEADLESS_GEMINI_CMD   — path to gemini CLI (default: gemini)"
echo "       AXON_SYNTHESIS_HEADLESS_GEMINI_MODEL — Gemini synthesis model override (optional)"
...
echo "  6. Infrastructure:   just services-up     # start"
echo "                       just services-down   # stop"
echo ""
